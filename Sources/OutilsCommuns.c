...
/*             passée; 0 sinon                              */                                                       
/* -------------------------------------------------------- */
int ajouter_tri_croissant(premier_niveau_t ** tete_liste, premier_niveau_t * nouvel_element, second_niveau_t ** tete_nouvelle_action, second_niveau_t * nouvelle_action)  
{
    int code = 1;
    int elem_entrez = 0;
