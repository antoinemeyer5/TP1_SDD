...
TEST(AJOUTER_SN_BON_ENDROIT)
{
    ...
    ajouter_en_tete_second_niveau(&liste, action_2);
    ajouter_en_tete_second_niveau(&liste, action_1);
...
TEST(RECHERCHER_MOTIF_SECOND_NIVEAU)
{
    ...
    ajouter_en_tete_second_niveau(&liste, action_2);
    ajouter_en_tete_second_niveau(&liste, action_1);
    //recherche d'un motif existant
    reponse = "5";
    rechercher_motif_second_niveau(liste_jours, "Vac", liste);
    comp = strcmp(liste_jours, reponse);
    CHECK(0 == comp);

    //recherche d'un motif inexistant
    reponse = "";
    rechercher_motif_second_niveau(liste_jours, "Parc", liste);
    comp = strcmp(liste_jours, reponse);
    CHECK(0 == comp);
}
TEST(RECHERCHER_MOTIF_PREMIER_NIVEAU)
{
    ...
    char *reponse = "1973027 1978027 1978057 2022501 ";
    int comp;
    remplir_agenda("fi.txt", &agenda);
    //recherche d'un motif existant
    rechercher_motif_premier_niveau(liste_dates, "a", agenda);
    comp = strcmp(reponse, liste_dates);
    CHECK(0 == comp);

    //recherche d'un motif inexistant
    reponse = "";
    rechercher_motif_premier_niveau(liste_dates, "Partir", agenda);
    comp = strcmp(reponse, liste_dates);
    CHECK(0 == comp);
}
